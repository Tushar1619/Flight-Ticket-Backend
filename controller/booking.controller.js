...
module.exports.createBookingAndTickets = async (req, res) => {
  ...
  bookingModel
    .create(req.body)
    .then(async (result) => {
      let emailMessage = `<div style="font-family:sans-serif"><div className="adM"> 
               ...
               <tbody>
                ...
                <tr> 
                 <td align="left" valign="top"> 
                  ...
                  <div style="width:100%;height:16px;display:block"></div> <p style="line-height:25px;font-size:16px;padding:0px;margin:0px"> Yêu cầu Book Now của quý khách đã được xác nhận thành công, Booking Code của quý khách là <span style="color: blue;">${result.pnr}</span></p> </td> 
                </tr> 
                <tr> 
      ...
      <img style="display:block;font-size:0px;line-height:0em" src="https://ci5.googleusercontent.com/proxy/cdw-MENhpV8AlrnT5wilQ84y-djlWqJlo1Y40enyGwtAepIbKqZ1n3IO5PEvpNTzcwV1jrExm7f2tV9dUGXp7GmWt-fV18hMeL6XNscX9uKo3OJQXMWrq75yptw=s0-d-e1-ft#https://messaging-callback-api.msg.traveloka.com/o?id=1697564480904392067" alt="" width="1" height="1" border="0" className="CToWUd"><div className="yj6qo"></div><div className="adL">
     </div>
    </div>`;
      email = result.email;
